...
public class Result {
    ...
    public Result (ResultType resultType,UUID id, String firstName,String lastName, String gender, String email, String birthString, String testString, boolean result, double testSpecifity) {
